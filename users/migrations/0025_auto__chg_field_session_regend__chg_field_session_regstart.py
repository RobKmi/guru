...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.regend'
        db.alter_column(u'users_session', 'regend', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Session.regstart'
        db.alter_column(u'users_session', 'regstart', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Session.regend'
        db.alter_column(u'users_session', 'regend', self.gf('django.db.models.fields.TimeField')(auto_now=True))

        # Changing field 'Session.regstart'
        db.alter_column(u'users_session', 'regstart', self.gf('django.db.models.fields.TimeField')(auto_now=True))
    ...
    models = {
        ...
        u'users.session': {
            ...
            'regend': ('django.db.models.fields.DateTimeField', [], {'default': "'2000-01-01'"}),
            'regstart': ('django.db.models.fields.DateTimeField', [], {'default': "'2000-01-01'"}),
