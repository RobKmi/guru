...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'users_session', 'active')

        # Adding field 'Session.regstart'
        db.add_column(u'users_session', 'regstart',
                      self.gf('django.db.models.fields.DateField')(default='2000-01-01'),
                      keep_default=False)

        # Adding field 'Session.regend'
        db.add_column(u'users_session', 'regend',
                      self.gf('django.db.models.fields.DateField')(default='2000-01-01'),
                      keep_default=False)

        # Adding field 'Session.manualend'
        db.add_column(u'users_session', 'manualend',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'users_session', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Session.regstart'
        db.delete_column(u'users_session', 'regstart')

        # Deleting field 'Session.regend'
        db.delete_column(u'users_session', 'regend')

        # Deleting field 'Session.manualend'
        db.delete_column(u'users_session', 'manualend')
    ...
    models = {
        ...
        u'users.postdatatemp': {
            'Meta': {'object_name': 'PostDataTemp'},
            'change_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '4096'})
        },
        u'users.postdatatemparch': {
            'Meta': {'object_name': 'PostDataTempArch'},
            'change_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'value': ('django.db.models.fields.CharField', [], {'max_length': '4096'})
        ...
        u'users.session': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manualend': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'regend': ('django.db.models.fields.DateField', [], {'default': "'2000-01-01'"}),
            'regstart': ('django.db.models.fields.DateField', [], {'default': "'2000-01-01'"}),
