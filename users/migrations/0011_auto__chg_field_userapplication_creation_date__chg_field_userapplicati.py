...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserApplication.creation_date'
        db.alter_column('users_userapplication', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UserApplication.change_date'
        db.alter_column('users_userapplication', 'change_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

    def backwards(self, orm):

        # Changing field 'UserApplication.creation_date'
        db.alter_column('users_userapplication', 'creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'UserApplication.change_date'
        db.alter_column('users_userapplication', 'change_date', self.gf('django.db.models.fields.DateField')(auto_now=True))
