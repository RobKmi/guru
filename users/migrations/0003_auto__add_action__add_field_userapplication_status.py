...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Action'
        db.create_table('users_action', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=1024)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
            ('required_status', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ...
        db.send_create_signal('users', ['Action'])

        # Adding field 'UserApplication.status'
        db.add_column('users_userapplication', 'status',
                      self.gf('django.db.models.fields.CharField')(default='new', max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Action'
        db.delete_table('users_action')

        # Deleting field 'UserApplication.status'
        db.delete_column('users_userapplication', 'status')
    ...
    models = {
        ...
        'users.userapplication': {
            ...
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'declaration': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_date': ('django.db.models.fields.DateField', [], {}),
            'end_time': ('django.db.models.fields.IntegerField', [], {}),
            'first_time': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'applications'", 'to': "orm['users.Session']"}),
            'start_date': ('django.db.models.fields.DateField', [], {}),
