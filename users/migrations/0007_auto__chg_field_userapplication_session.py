...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserApplication.session'
        db.alter_column('users_userapplication', 'session_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.Session']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserApplication.session'
        raise RuntimeError("Cannot reverse this migration. 'UserApplication.session' and its values cannot be restored.")
    ...
    models = {
        ...
        'users.postdata': {
            ...
            'session_id': ('django.db.models.fields.CharField', [], {'max_length': '1024'}),
