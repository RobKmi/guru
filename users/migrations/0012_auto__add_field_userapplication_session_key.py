...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserApplication.session_key'
        db.add_column('users_userapplication', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='aaa', max_length=1024),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserApplication.session_key'
        db.delete_column('users_userapplication', 'session_key')
