...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Session.uid'
        db.add_column(u'users_session', 'uid',
        ...
        # Adding field 'Session.maxcap'
        db.add_column(u'users_session', 'maxcap',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Session.maxcapnew'
        db.add_column(u'users_session', 'maxcapnew',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Session.uid'
        db.delete_column(u'users_session', 'uid')

        # Deleting field 'Session.active'
        db.delete_column(u'users_session', 'active')

        # Deleting field 'Session.maxcap'
        db.delete_column(u'users_session', 'maxcap')

        # Deleting field 'Session.maxcapnew'
        db.delete_column(u'users_session', 'maxcapnew')
