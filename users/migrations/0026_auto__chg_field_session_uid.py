...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Session.uid'
        db.alter_column(u'users_session', 'uid', self.gf('django.db.models.fields.IntegerField')(max_length=100, unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'Session.uid'
        db.alter_column(u'users_session', 'uid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
    ...
    models = {
        ...
        u'users.session': {
            ...
            'uid': ('django.db.models.fields.IntegerField', [], {'max_length': '100', 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
