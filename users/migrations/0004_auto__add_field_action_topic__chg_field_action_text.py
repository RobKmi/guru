...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.topic'
        db.add_column('users_action', 'topic',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Action.text'
        db.alter_column('users_action', 'text', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Action.topic'
        db.delete_column('users_action', 'topic')


        # User chose to not deal with backwards NULL issues for 'Action.text'
        raise RuntimeError("Cannot reverse this migration. 'Action.text' and its values cannot be restored.")
