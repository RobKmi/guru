...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserApplication.session'
        db.add_column('users_userapplication', 'session',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, related_name='applications', to=orm['users.Session']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserApplication.session'
        db.delete_column('users_userapplication', 'session_id')
