...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_userprofile', (
            ...
            ('city', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserProfile'])

        # Adding model 'Session'
        db.create_table('users_session', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('users', ['Session'])

        # Adding model 'UserApplication'
        db.create_table('users_userapplication', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('declaration', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('change_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserApplication'])

        # Adding model 'UserPayment'
        db.create_table('users_userpayment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments', to=orm['auth.User'])),
            ('money', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('creation_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
            ('change_date', self.gf('django.db.models.fields.DateField')(auto_now=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
        ))
        db.send_create_signal('users', ['UserPayment'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('users_session')

        # Deleting model 'UserApplication'
        db.delete_table('users_userapplication')

        # Deleting model 'UserPayment'
        db.delete_table('users_userpayment')
