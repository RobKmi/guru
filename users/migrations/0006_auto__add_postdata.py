...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_postdata', (
            ...
            ('session_id', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('users', ['PostData'])


    def backwards(self, orm):
        # Deleting model 'PostData'
        db.delete_table('users_postdata')
