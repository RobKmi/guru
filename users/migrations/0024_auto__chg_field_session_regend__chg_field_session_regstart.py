...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Session.regend'
        db.alter_column(u'users_session', 'regend', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Session.regstart'
        db.alter_column(u'users_session', 'regstart', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'users.session': {
            ...
            'regend': ('django.db.models.fields.TimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'regstart': ('django.db.models.fields.TimeField', [], {'auto_now': 'True', 'blank': 'True'}),
