...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PostData.session_id'
        db.delete_column('users_postdata', 'session_id')

        # Adding field 'PostData.session_key'
        db.add_column('users_postdata', 'session_key',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PostData.session_id'
        raise RuntimeError("Cannot reverse this migration. 'PostData.session_id' and its values cannot be restored.")
        # Deleting field 'PostData.session_key'
        db.delete_column('users_postdata', 'session_key')
